...
class OrderItemInline(admin.TabularInline):
    ...
    def image_preview(self, obj):
        if obj.product.main_image:
            return mark_safe(f'<img scr="{obj.product.main_image.url}" style="max-height: 100px; "max_width:100px; object-fit: cover;" />')
    ...
    get_total_price.short_description = 'Total_Price'
